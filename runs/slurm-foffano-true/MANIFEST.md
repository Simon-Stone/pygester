...
Tool version: `0.1.0` · Run at: `2026-05-14T17:17:56.976776+00:00` · Flags: `--formula-enrichment true --code-enrichment false --ocr false`
...
```bash
python src/01-parse.py "assets/Foffano et al. - 2023 - Conformal Off-Policy Evaluation in Markov Decision Processes.pdf" --out <OUT_DIR> --formula-enrichment true --code-enrichment false --ocr false
