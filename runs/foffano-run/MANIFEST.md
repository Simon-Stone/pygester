...
Tool version: `0.1.0` · Run at: `2026-05-13T21:46:22.311477+00:00` · Flags: `--formula-enrichment false --code-enrichment false --ocr false`
...
- Formula enrichment: `false` — math came through as Unicode soup
...
```bash
python scripts/01-parse.py "assets/Foffano et al. - 2023 - Conformal Off-Policy Evaluation in Markov Decision Processes.pdf" --out <OUT_DIR> --formula-enrichment false --code-enrichment false --ocr false
