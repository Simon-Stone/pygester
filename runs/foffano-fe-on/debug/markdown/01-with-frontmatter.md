...
tool_version: 0.1.0
run_at: 2026-05-13T15:43:26.152438+00:00
...
$$\hat { C } _ { n } ( x ) \coloneqq \left \{ y \in \mathbb { R } \colon s ( x , y ) \leq \text {Quantile} _ { 1 - \alpha } \left ( \hat { F } _ { n } ^ { x , y } \right ) \right \} . \ \ ( 3 ) \quad ^ { 1 \text {Find} } \quad \text {com/da} \quad \text {Conform}$$
...
$$s ( x , y ) = \max ( q _ { \alpha _ { h } } ( x ) - y , y - q _ { \alpha _ { h } } ( x ) ) , \\$$
...
$$\hat { C } _ { n } ( x ) \coloneqq \left \{ y \in \mathbb { R } \colon q _ { \alpha _ { 1 } } ( x ) - y \leq \text {Quantile} _ { 1 - \alpha / 2 } \left ( \hat { F } _ { n , 0 } ^ { x , y } \right ) \right \} \\ \cap \left \{ y \in \mathbb { R } \colon y - q _ { \alpha _ { 1 } } ( x ) \leq \text {Quantile} _ { 1 - \alpha / 2 } \left ( \hat { F } _ { n , 1 } ^ { x , y } \right ) \right \} , \quad \text {where } \pi ^ { n } \\ ( \tau ) \colon \quad \text {P} ^ { n } ( \tau | x )$$
...
$$\mathbb { P } ^ { \pi ^ { b } , \pi } \left [ Y \in \hat { C } _ { n } ( X ) \right ] & \geq 1 - \alpha . & ( 8 ) \\ \text {also obtain the following guarantees in case } w ( x , y ) \\ \text {and by } \hat { w } ( x , y )$$
...
$$\exp \text {c-} \int _ { f } \min _ { \substack { \min \mathbb { E } \\ ( 1 1 ) } } \frac { \min _ { \substack { E \\ ( X , Y , \tau ) \sim P _ { X , Y , \tau } ^ { b } \\ X , Y , \tau } } \left [ \left ( \frac { \prod _ { t = 1 } ^ { H } \pi ( a _ { t } | x _ { t } ) } { \prod _ { t = 1 } ^ { H } \pi ^ { b } ( a _ { t } | x _ { t } ) } - f ( X , Y ) \right ) ^ { 2 } \right ] . \\ \text {There, given some function approximator } f _ { \theta } \text { parametrized}$$

Therefore, given some function approximator f θ parametrized by θ , we can minimize over θ the following empirical risk:

$$\begin{array} { r l } & { \quad b y \, 0 , \, w e c a n \, m m i n e \, 0 v e r \, 0 \, a n d \, n o w i n g \, e p l o w e r \, n o w i n g . } \\ { c a s } & { \quad \frac { 1 } { m } \sum _ { \tau ^ { i } \in \mathcal { D } _ { t r } } \left ( \frac { \prod _ { t = 1 } ^ { H } \pi ( a _ { t } ^ { ( i ) } | x _ { t } ^ { ( i ) } ) } { \prod _ { t = 1 } ^ { H } \pi ^ { b } ( a _ { t } ^ { ( i ) } | x _ { t } ^ { ( i ) } ) } - f _ { \theta } \left ( x _ { 1 } ^ { ( i ) } , \sum _ { t = 1 } ^ { H } r _ { t } ^ { ( i ) } \right ) \right ) ^ { 2 } . } \\ & { \quad d a t a } & { \quad \ A s \, o n e \, w o u d \, e x p t , \, this \, m o d \, s t i l \, s u f f i l c r s \, f o r \, a n d \, n o w i n g . } \end{array}$$
...
$$\text {and} \, , \quad q _ { \alpha } ^ { \pi } ( x ) = \text {Quantile} _ { \alpha } \left ( \sum _ { y \in \mathcal { I } ( x ) } \frac { w \left ( x , y \right ) } { \sum _ { y ^ { \prime } \in \mathcal { I } ( x ) } w \left ( x , y ^ { \prime } \right ) } \delta _ { y } \right ) , \\ \text {only} \, , \quad \text {where } \mathcal { I } ( x ) = \{ y \in \mathcal { D } _ { c a l } \colon x _ { 1 } = x \} , \, i . e . , \, \text {we only consider} \, \intertext { \text {and} } , \quad \text {a} \quad q _ { \alpha } ^ { \pi } ( x ) = \text {Quantile} _ { \alpha } \left ( \sum _ { y \in \mathcal { I } ( x ) } \frac { w \left ( x , y \right ) } { \sum _ { y ^ { \prime } \in \mathcal { I } ( x ) } w \left ( x , y ^ { \prime } \right ) } \delta _ { y } \right ) , \\ \text {only} \, , \quad \text {where } \mathcal { I } ( x ) = \{ y \in \mathcal { D } _ { c a l } \colon x _ { 1 } = x \} , \, i . e . , \, \text {we only consider} \, \intertext { \text {and} } , \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {a} \quad \text {$$
