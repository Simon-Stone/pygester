...
Tool version: `0.1.0` · Run at: `2026-05-13T15:43:26.152438+00:00` · Flags: `--formula-enrichment on --code-enrichment off --ocr off`
...
- Formula enrichment: `on` — math came through as LaTeX
...
```bash
python scripts/01-parse.py "assets/Foffano et al. - 2023 - Conformal Off-Policy Evaluation in Markov Decision Processes.pdf" --out <OUT_DIR> --formula-enrichment on --code-enrichment off --ocr off
