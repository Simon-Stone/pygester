...
Tool version: `0.1.0` · Run at: `2026-05-14T21:17:31.639786+00:00` · Flags: `--formula-enrichment true --code-enrichment false --ocr false`
...
- **`pages/page_NNNN.png`** — one rasterized image per page (9 total).
...
```bash
python src/01-parse.py "assets/Nikishin et al. - 2022 - Control-Oriented Model-Based Reinforcement Learning with Implicit Differentiation.pdf" --out <OUT_DIR> --formula-enrichment true --code-enrichment false --ocr false
